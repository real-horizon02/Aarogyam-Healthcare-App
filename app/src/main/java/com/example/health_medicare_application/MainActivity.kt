...
import com.example.health_medicare_application.ui.theme.Aarogyam_ApplicationTheme
...
fun BottomBar(navController: NavController) {
    ...
    {
        val button = ButtonDefaults.buttonColors(purple673)
